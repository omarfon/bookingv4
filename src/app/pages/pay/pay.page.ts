...
export class PayPage implements OnInit {
  ...
  checkStatus() {
    this.check = setInterval(() => {
      this.appointmentProvider.chekstatusAppointment(this.appointmentId).subscribe(async (status: any) => {
        console.log({ status })
  ...
  checkStatusParent() {
    ...
    this.check = setInterval(() => {
      this.appointmentProvider.chekstatusAppointmentParent(userId, appointmentId).subscribe(async (status: any) => {
        console.log({ status });
        if (status.status === "pendiente") {
          console.log('sigue pendiente');
        } else {
